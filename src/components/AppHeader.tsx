...
import { SyncDialogContext } from '../contexts/SyncDialogContext';
import { t } from '../i18n';

import { WalletDialog } from './cashu/WalletDialog';
...
export function AppHeader(props: AppHeaderProps) {
  ...
  return (
    <SyncDialogContext.Provider value={{ openSyncDialog: () => setSyncDialogOpen(true) }}>
      <div class="flex items-center justify-end gap-1 py-2">
        ...
        <SyncDataDialog open={syncDialogOpen()} onClose={() => setSyncDialogOpen(false)} />
        <WalletDialog open={walletDialogOpen()} onClose={() => setWalletDialogOpen(false)} />
      </div>
    </SyncDialogContext.Provider>
  );
}
